...
TASKS = [
    ...
    ('T-10', 'ファイル整理(2回目)の承認', LIST_NAME, 'シート「質問」の Q18・Q19',
     '英樹 2026-09-21「ファイルが溜まりすぎてるから整理して」→ 整理案 Output/整理案_20260921.txt を読んで Q18(移動38件)・Q19(削除候補31件)に答える。Claude Code は承認後に実行(削除はしない・退避のみ)',
     'Q18・Q19 が回答済 → 保存して閉じ、チャットで「整理OK」', ''),
]
DONE = [
